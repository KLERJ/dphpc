...
#pragma omp parallel default(none)                                             \
    shared(w, h, a1, a2, a3, a4, b1, b2, imgIn, y1, y2)
  {
#pragma omp for private(j, xm1, ym1, ym2) nowait
    for (i = 0; i < _PB_W; i++) {
      ym1 = SCALAR_VAL(0.0);
      ym2 = SCALAR_VAL(0.0);
      xm1 = SCALAR_VAL(0.0);
...
#pragma omp for private(j, xp1, xp2, yp1, yp2)
    for (i = 0; i < _PB_W; i++) {
      yp1 = SCALAR_VAL(0.0);
      yp2 = SCALAR_VAL(0.0);
      xp1 = SCALAR_VAL(0.0);
...
#pragma omp parallel default(none)                                             \
    shared(w, h, a5, a6, a7, a8, b1, b2, imgOut, y1, y2)
  {
#pragma omp for private(i, tm1, ym1, ym2) nowait
    for (j = 0; j < _PB_H; j++) {
      tm1 = SCALAR_VAL(0.0);
      ym1 = SCALAR_VAL(0.0);
      ym2 = SCALAR_VAL(0.0);
...
#pragma omp for private(i, tp1, tp2, yp1, yp2)
    for (j = 0; j < _PB_H; j++) {
      tp1 = SCALAR_VAL(0.0);
      tp2 = SCALAR_VAL(0.0);
      yp1 = SCALAR_VAL(0.0);
