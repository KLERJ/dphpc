...
int main(int argc, char **argv) {
  ...
  const int n_requests = segments_per_rank * size;
  ...
  /* Wait until all blocks of our segment have been received */
  MPI_Waitall(n_requests, requests, MPI_STATUS_IGNORE);
